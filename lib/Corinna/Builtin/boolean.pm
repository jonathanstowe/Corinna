...
B<Corinna::Builtin::boolean> represents the B<builtin> W3C type B<boolean>.
Mainly it serves to override the L</boolify> method for overloading (see
L</boolify>).
...
The B<boolify()> method is used for overloading the 'bool' operation in
L<Corinna::SimpleType>.  Normally the string 'I<false>' will have a TRUE(1)
value in Perl (since it is a non-null string). This method will make sure that
the 'I<false>' literal value will pass as a FALSE(0) value while the overload
