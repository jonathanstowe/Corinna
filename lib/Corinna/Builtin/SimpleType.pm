...
At this time, this class is just used for grouping the B<builtin> classes.  No
methods are defined at this level.
...
L<Corinna::SimpleType> for more methods.
