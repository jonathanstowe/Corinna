...
B<Corinna::Builtin::dateTime> represents the B<builtin> W3C type B<dateTime>.
...
The B<from_date_time()> constructor method instantiates a new object from
L<DateTime> object.  It is inheritable. The necessary conversion is done
within the method.
...
This method sets the value of the object from a L<DateTime> object.  The
...
This method returns the value of the object as a L<DateTime> object.  The
necessary conversion is done within the method.

=head4 xml_validate_further()

This method is overriden from L<Corinna::SimpleType> so that B<dateTime>
values can be checked for logical inconsistencies. For example, a B<month>
value of I<14> will cause an error (die).
