...
B<Corinna::NodeArray> is an array class that is used for element multiplicity
in L<Corinna>.

Normally, B<Corinna::NodeArray> is an array of hashes or hash-based objects.
This class has some magical properties that make it easier to deal with
multiplicity.

B<Corinna::NodeArray> is a simple wrapper around the generic class
L<Data::HashArray>. Please see the documentation of L<Data::HashArray> for
more details.
