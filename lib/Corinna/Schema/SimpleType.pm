...
This class descends from L<Corinna::Schema::Type> and hence from
<Corinna::Schema::Object>.
...
B<Corinna::Schema::SimpleType> is a data-oriented object class that reprsents
a W3C Simple Type. It is parsed from the W3C schema and is used a building
block for the produced B<schema model>. It is also used embedded as class data
within the simple classes generated by L<Corinna>. This way, objects of this
class contain META information about the W3C schema simple type that they
represent.
...
In its overriden form, what this method does is to set the I<contentType>
field to 'I<simple>'.
...
L<Corinna::Schema::Type> and L<Corinna::Schema::Object>.  Please see
L<Corinna::Schema::Type> and L<Corinna::Schema::Object> for a documentation of
those.
...
This field, if present, signifies the number of fractional digits that numeric
...
This field, if present, signifies a numeric value that the values of this
...
This field, if present, signifies the B<maximum> numeric value that the values
...
This field, if present, signifies the B<maximum> string length that the values
of this simple type can have. This is obtained directly from the W3C schema
and placed here by the parser. It is later used for validation.
...
This field, if present, signifies the B<minimum> numeric value that the values
of this simple type can have. This is obtained directly from the W3C schema
and placed here by the parser. It is later used for validation.
...
This field, if present, signifies the B<minimum> string length that the values
of this simple type can have. This is obtained directly from the W3C schema
and placed here by the parser. It is later used for validation.
...
This field, if present, gives a W3C regular expression to which the values of
...
This is NOT a W3C facet. But it is used as such internally by L<Corinna> in
order to give constraints to builtin types.

This field, if present, gives a Perl regular expression to which the values of
this simple type must match. It is similar to the L</pattern()> field accept
that the B<regex()> field will always be guaranteed to be a Perl regular
expression whereas 'pattern' may digresse in the future.  This is obtained
...
This field, if present, signifies the total number of digits that numeric
values of this simple type must have. This is obtained directly from the W3C
schema and placed here by the parser. It is later used for validation.
...
This field, if present, signifies treatment of whitespace within a the values
of this simple type upon validation.  Currently, three values are possible =>
'I<preserve>'(default), 'I<collapse>', 'I<replace>'.  This is obtained
directly from the W3C schema and placed here by the parser. It is later used
for validation.
