...
The base classes of this element class, when it is generated by L<Corinna>.
This value is computed at schema model I<resolution> time by
...
The maximum allowed occurences of this child element. This can be any
non-negative integer or the string 'I<unbounded>'.
...
The minimum allowed occurences of this child element. This can be any
non-negative integer.  When it is zero (0), this means the occurence of this
...
This returns a boolean value. When TRUE(1), this means that the child element
is a singleton, meaning the B<maxOccurs> property is either undefined or it is
exactly 1.
