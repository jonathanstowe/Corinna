...
Returns the schema model object (of type L<XML::Schema::Model>) associated
with the set of schemas that were used for the code generation.

You can actually assign a model with this method as well, just by passing a
reference as the only argument. But why would you want to do it?
